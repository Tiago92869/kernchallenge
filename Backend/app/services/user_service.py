...
class UserService:
    ...
    def check_email_format(email: str) -> bool:
        ...
        return not ("@" not in email or "." not in email)
    ...
    @staticmethod
    def update_password(*, user_id: UUID, old_password: str, new_password: str) -> None:
        user = UserRepository.get_by_id(user_id)
    ...
    @staticmethod
    def get_all_users(
        *, search: str | None = None, is_active: bool | str | None = None
    ) -> list[User]:
