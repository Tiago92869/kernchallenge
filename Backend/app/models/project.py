...
class Project(db.Model):
    ...
    visibility = db.Column(
        db.Enum(ProjectVisibility, name="project_visibility"),
        nullable=False,
    ...
    archived_by = db.relationship(
        "User", foreign_keys=[archived_by_user_id], back_populates="archived_projects_actions"
    )
    ...
    notifications = db.relationship(
        "Notification", foreign_keys="Notification.project_id", back_populates="project", lazy=True
    )
    time_entries = db.relationship(
        "TimeEntry", foreign_keys="TimeEntry.project_id", back_populates="project", lazy=True
    )
